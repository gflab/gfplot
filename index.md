...
| Area | Functions |
|----|----|
| Survival | [`plot_KMCurve()`](https://gaofeng21cn.github.io/gfplot/reference/plot_KMCurve.md), [`generate_time_event()`](https://gaofeng21cn.github.io/gfplot/reference/generate_time_event.md) |
| Discrimination | [`plot_ROC()`](https://gaofeng21cn.github.io/gfplot/reference/plot_ROC.md), [`plot_TimeROC()`](https://gaofeng21cn.github.io/gfplot/reference/plot_TimeROC.md), [`plot_MulROC()`](https://gaofeng21cn.github.io/gfplot/reference/plot_MulROC.md) |
| Sample-level figures | [`plot_RiskScore()`](https://gaofeng21cn.github.io/gfplot/reference/plot_RiskScore.md), [`plot_Boxplot()`](https://gaofeng21cn.github.io/gfplot/reference/plot_Boxplot.md), [`plot_barplot()`](https://gaofeng21cn.github.io/gfplot/reference/plot_barplot.md), [`plot_cor()`](https://gaofeng21cn.github.io/gfplot/reference/plot_cor.md) |
| Projections and models | [`plot_PCA()`](https://gaofeng21cn.github.io/gfplot/reference/plot_PCA.md), [`plot_UMAP()`](https://gaofeng21cn.github.io/gfplot/reference/plot_UMAP.md), [`plot_lasso()`](https://gaofeng21cn.github.io/gfplot/reference/plot_lasso.md) |
| Enrichment and immune figures | [`plot_GO()`](https://gaofeng21cn.github.io/gfplot/reference/plot_GO.md), [`viewGSEA()`](https://gaofeng21cn.github.io/gfplot/reference/viewGSEA.md), [`ggGSEA()`](https://gaofeng21cn.github.io/gfplot/reference/ggGSEA.md), [`plot_immune()`](https://gaofeng21cn.github.io/gfplot/reference/plot_immune.md) |
| Helpers | [`get_color()`](https://gaofeng21cn.github.io/gfplot/reference/get_color.md) |
...
| Function | Back end |
|----|----|
| [`plot_KMCurve()`](https://gaofeng21cn.github.io/gfplot/reference/plot_KMCurve.md) | `survminer` |
| [`plot_TimeROC()`](https://gaofeng21cn.github.io/gfplot/reference/plot_TimeROC.md) | `survivalROC` (or `timeROC` for new work) |
| [`plot_UMAP()`](https://gaofeng21cn.github.io/gfplot/reference/plot_UMAP.md) | `umap` |
| [`plot_lasso()`](https://gaofeng21cn.github.io/gfplot/reference/plot_lasso.md) | `glmnet` |
| [`plot_immune()`](https://gaofeng21cn.github.io/gfplot/reference/plot_immune.md) | `ggradar` |
| [`viewGSEA()`](https://gaofeng21cn.github.io/gfplot/reference/viewGSEA.md), [`ggGSEA()`](https://gaofeng21cn.github.io/gfplot/reference/ggGSEA.md) | `DOSE`, `HTSanalyzeR2`, `fgsea` |
| [`plot_barplot()`](https://gaofeng21cn.github.io/gfplot/reference/plot_barplot.md) significance | `ggpubr` |
