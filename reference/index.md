...
- [`generate_time_event()`](https://gaofeng21cn.github.io/gfplot/reference/generate_time_event.md)
...
- [`plot_PCA()`](https://gaofeng21cn.github.io/gfplot/reference/plot_PCA.md)
  : Principal component analysis plot
- [`plot_UMAP()`](https://gaofeng21cn.github.io/gfplot/reference/plot_UMAP.md)
  : UMAP projection plot
- [`plot_lasso()`](https://gaofeng21cn.github.io/gfplot/reference/plot_lasso.md)
  : Plot lasso coefficient paths

## Enrichment and immune figures

- [`plot_GO()`](https://gaofeng21cn.github.io/gfplot/reference/plot_GO.md)
  : Dot plot of enriched terms
- [`viewGSEA()`](https://gaofeng21cn.github.io/gfplot/reference/viewGSEA.md)
  : Plot a running enrichment score for an HTSanalyzeR2 result
- [`ggGSEA()`](https://gaofeng21cn.github.io/gfplot/reference/ggGSEA.md)
